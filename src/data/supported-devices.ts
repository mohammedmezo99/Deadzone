...
export const verifiedDeviceImageByCodename: Record<string, string> = {
    ...
    air: "/devices/air.webp",
    alioth: "/devices/alioth.webp",
    amethyst: "/devices/amethyst.webp",
    annibale: "/devices/annibale.webp",
    arctic: "/devices/arctic.webp",
    aristotle: "/devices/aristotle.webp",
    ares: "/devices/ares.webp",
    aurora: "/devices/aurora.webp",
    babylon: "/devices/babylon.webp",
    beryl: "/devices/beryl.webp",
    bhima: "/devices/bhima.webp",
    bixi: "/devices/bixi.webp",
    blue: "/devices/blue.webp",
    breeze: "/devices/breeze.webp",
    dash: "/devices/dash.webp",
    camellia: "/devices/camellia.webp",
    camellian: "/devices/camellian.webp",
    chenfeng: "/devices/chenfeng.webp",
    cetus: "/devices/cetus.webp",
    chopin: "/devices/chopin.webp",
    citrus: "/devices/citrus.webp",
    courbet: "/devices/courbet.webp",
    corot: "/devices/corot.webp",
    creek: "/devices/creek.webp",
    cupid: "/devices/cupid.webp",
    dada: "/devices/dada.webp",
    dagu: "/devices/dagu.webp",
    dali: "/devices/dali.webp",
    daumier: "/devices/daumier.webp",
    dandelion: "/devices/dandelion.webp",
    degas: "/devices/degas.webp",
    dijun: "/devices/dijun.webp",
    diting: "/devices/diting.webp",
    dizi: "/devices/dizi.webp",
    duchamp: "/devices/duchamp.webp",
    dew: "/devices/dew.webp",
    earth: "/devices/earth.webp",
    emerald: "/devices/emerald.webp",
    "emerald-r": "/devices/emerald-r.webp",
    flame: "/devices/flame.webp",
    evergreen: "/devices/evergreen.webp",
    fire: "/devices/fire.webp",
    fleur: "/devices/fleur.webp",
    fog: "/devices/fog.webp",
    flourite: "/devices/flourite.webp",
    flute: "/devices/flute.webp",
    fuxi: "/devices/fuxi.webp",
    garnet: "/devices/garnet.webp",
    gale: "/devices/gale.webp",
    gold: "/devices/gold.webp",
    goya: "/devices/goya.webp",
    goku: "/devices/goku.webp",
    haotian: "/devices/haotian.webp",
    haydn: "/devices/haydn.webp",
    ice: "/devices/ice.webp",
    houji: "/devices/houji.webp",
    ingres: "/devices/ingres.webp",
    ishtar: "/devices/ishtar.webp",
    jinghu: "/devices/jinghu.webp",
    klimt: "/devices/klimt.webp",
    kunzite: "/devices/kunzite.webp",
    klee: "/devices/klee.webp",
    koto: "/devices/koto.webp",
    lake: "/devices/lake.webp",
    lapis: "/devices/lapis.webp",
    lisa: "/devices/lisa.webp",
    light: "/devices/light.webp",
    liuqin: "/devices/liuqin.webp",
    luming: "/devices/luming.webp",
    malachite: "/devices/malachite.webp",
    manet: "/devices/manet.webp",
    marble: "/devices/marble.webp",
    matisse: "/devices/matisse.webp",
    mayfly: "/devices/mayfly.webp",
    mars: "/devices/mars.webp",
    miro: "/devices/miro.webp",
    mojito: "/devices/mojito.webp",
    mona: "/devices/mona.webp",
    mondrian: "/devices/mondrian.webp",
    moon: "/devices/moon.webp",
    moonstone: "/devices/moonstone.webp",
    munch: "/devices/munch.webp",
    muyu: "/devices/muyu.webp",
    myron: "/devices/myron.webp",
    nabu: "/devices/nabu.webp",
    nezha: "/devices/nezha.webp",
    nuwa: "/devices/nuwa.webp",
    obsidian: "/devices/obsidian.webp",
    onyx: "/devices/onyx.webp",
    organ: "/devices/organ.webp",
    pearl: "/devices/pearl.webp",
    peridot: "/devices/peridot.webp",
    piano: "/devices/piano.webp",
    pipa: "/devices/pipa.webp",
    pissarro: "/devices/pissarro.webp",
    plato: "/devices/plato.webp",
    psyche: "/devices/psyche.webp",
    pudding: "/devices/pudding.webp",
    rembrandt: "/devices/rembrandt.webp",
    renoir: "/devices/renoir.webp",
    redwood: "/devices/redwood.webp",
    rock: "/devices/rock.webp",
    rubens: "/devices/rubens.webp",
    rosemary: "/devices/rosemary.webp",
    rodin: "/devices/rodin.webp",
    rothko: "/devices/rothko.webp",
    ruyi: "/devices/ruyi.webp",
    ruan: "/devices/ruan.webp",
    ruby: "/devices/ruby.webp",
    sapphire: "/devices/sapphire.webp",
    sapphiren: "/devices/sapphiren.webp",
    sea: "/devices/sea.webp",
    selene: "/devices/selene.webp",
    selenes: "/devices/selenes.webp",
    serenity: "/devices/serenity.webp",
    sheng: "/devices/sheng.webp",
    shennong: "/devices/shennong.webp",
    sky: "/devices/sky.webp",
    socrates: "/devices/socrates.webp",
    spinel: "/devices/spinel.webp",
    spring: "/devices/spring.webp",
    spes: "/devices/spes.webp",
    star: "/devices/star.webp",
    sunstone: "/devices/sunstone.webp",
    surya: "/devices/surya.webp",
    sweet: "/devices/sweet.webp",
    taiko: "/devices/taiko.webp",
    tanzanite: "/devices/tanzanite.webp",
    taoyao: "/devices/taoyao.webp",
    tapas: "/devices/tapas.webp",
    thor: "/devices/thor.webp",
    topaz: "/devices/topaz.webp",
    turner: "/devices/turner.webp",
    uke: "/devices/uke.webp",
    unicorn: "/devices/unicorn.webp",
    vayu: "/devices/vayu.webp",
    venus: "/devices/venus.webp",
    violin: "/devices/violin.webp",
    vermeer: "/devices/vermeer.webp",
    vili: "/devices/vili.webp",
    viva: "/devices/viva.webp",
    veux: "/devices/veux.webp",
    water: "/devices/water.webp",
    warm: "/devices/warm.webp",
    xaga: "/devices/xaga.webp",
    xig02: "/devices/xig02.webp",
    xuanyuan: "/devices/xuanyuan.webp",
    xun: "/devices/xun.webp",
    yili: "/devices/yili.webp",
    yudi: "/devices/yudi.webp",
    yunluo: "/devices/yunluo.webp",
    yupei: "/devices/yupei.webp",
    zeus: "/devices/zeus.webp",
    zijin: "/devices/zijin.webp",
    zircon: "/devices/zircon.webp",
    ziyi: "/devices/ziyi.webp",
    zizhan: "/devices/zizhan.webp",
